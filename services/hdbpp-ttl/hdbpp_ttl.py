...
basis that yeseryday is the first day of a time to live value, i.e. todays data is
...
def add_defaults_to_config(config):
    """
    Ensure the defaults for certain config params are part of ther configuration
